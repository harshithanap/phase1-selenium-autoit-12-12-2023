package com.harshi.seleniumtest;
...
public class UploadProfileImgToGithubTest {
	...
	public static void uploadProfile() throws IOException, InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"settings-frame\"]/div[2]/div[2]/dl/dd/div/details/summary/img")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"avatar-crop-form\"]/div[2]/button/span/span")).click();
